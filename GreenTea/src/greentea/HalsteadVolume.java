...
public class HalsteadVolume {
	...
	/**
	 * Get Source code that remove string warped with " ".  
	 * ex) system.out.println("this string will be removed") => system.out.println()
	 * 
	 * @param source 	source code
	 ...
	 * 
	 * @param StrTokens	Tokens of source code that are divided by " ".
	 */
